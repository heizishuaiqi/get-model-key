    ...
    <div className="min-h-screen bg-bg-app text-text-primary">
      <main className="container-custom py-8 md:py-12 lg:py-16">
          ...
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-info-500/10">
                <svg className="h-6 w-6 text-info-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h3>3.2 分析工具</h3>
          <p>
            我们可能使用统计分析服务（如 Google Analytics）了解整体流量情况并改进网站。
          </p>

          <h3>3.3 广告</h3>
          <p>
            我们可能在部分页面展示第三方广告（包括 Adsterra）。这些合作方可能使用 Cookie
            或类似技术投放广告并衡量效果，其数据处理受各自隐私政策约束。
          </p>
